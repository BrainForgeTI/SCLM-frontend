...
export const useApi = () => ({
    ...
    const response: AdventureCardType[] = [
      {
        id: "8428ry428ohohr2",
        image:
          "https://th.bing.com/th/id/OIP.TM0OTN2mHyuByxuolBTEKQHaHk?rs=1&pid=ImgDetMain",
        title: "Aventura de React",
        colorFrom: "#DE9673",
        colorTo: "#E06527",
        character: {
          imageUrl:
            "https://media.discordapp.net/attachments/838520690726010993/1353736029655535646/WhatsApp_Image_2025-02-23_at_14.07.16__1_-removebg-preview_2_1.png?ex=67e2bc6c&is=67e16aec&hm=279c2a0a9952b1789ace57b5ccbd28aafb362a838bcfa4d8854f0b83a4d7c9e3&=&format=webp&quality=lossless&width=84&height=88",
          name: "Marcão",
          level: 50,
        },
        progress: 57,
      ...
      },
      {
        ...
        image:
          "https://th.bing.com/th/id/OIP.STVU4fmmXjJFCyIHW1L6jgHaHt?rs=1&pid=ImgDetMain",
        title: "Aventura de Java",
        colorFrom: "#86B8B9",
        colorTo: "#26B6B8",
        character: {
      ...
      },
      {
        ...
        image:
          "https://th.bing.com/th/id/OIP.BMXxh0nGocZLZfbY8m17UwHaHa?rs=1&pid=ImgDetMain",
        title: "Aventura de Java",
        colorFrom: "#86B8B9",
        colorTo: "#26B6B8",
        character: {
      ...
      },
      {
        ...
        image:
          "https://th.bing.com/th/id/OIP.xpoORYpm1DwR4H1K3SfKtwHaHa?w=500&h=500&rs=1&pid=ImgDetMain",
        title: "Aventura de Java",
        colorFrom: "#86B8B9",
        colorTo: "#26B6B8",
        character: {
  ...
  createAdventure: async (userId: string, adventure: AdventureCardType) => {
    ...
    if (random > 4) {
      response = {
        status: 201,
        cardId: `fjmwpijg39j3r-${Math.random() * 50000}`,
      };
    } else {
      response = { status: 500 };
    }
  ...
  validateToken: async (email: string, token: string) => {
    const res = await axios.post("http://127.0.0.1:3000/auth/validate-token", {
      email,
      token,
    });
  ...
  refreshToken: async () => {
    const res = await axios.get("http://127.0.0.1:3000/auth/refresh-token", {
