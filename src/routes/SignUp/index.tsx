    ...
    if (step === 4) {
      return (
        <SignUpFourthStep
          form={form}
          handleSubmit={handleSubmit}
          handleResend={mutateValidateEmail}
          tokenError={isErrorSignUpToken}
          isPendingTokenValidation={isPendingTokenValidation}
          isSuccessTokenValidation={isSuccessTokenValidation}
        />
      )
    }
  }
