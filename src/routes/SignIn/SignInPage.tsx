                    ...
                    <div className="w-[320px] lg:w-[384px] lg:block justify-center">
                        ...
                        <AuthFormsBox>
                            <div className="w-full flex flex-col gap-5">
                                ...
                                <p className="flex justify-center w-full text-foreground text-base">Esqueceu a senha?<a className="flex ml-2 text-blue-400 underline" href="">clique aqui</a></p>
                            </div>
                            
                        </AuthFormsBox>
                        <div className="flex flex-col w-full mt-6 p-[15px] rounded-[20px] text-foreground justify-items-center text-center bg-neutral/5">
