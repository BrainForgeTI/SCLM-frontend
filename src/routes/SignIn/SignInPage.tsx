            ...
            <AuthFormsBox>
              <div className="w-full flex flex-col gap-5">
                ...
                <button
                  onClick={handleLogin}
                  type="button"
                  className="text-white w-full p-[10px] bg-primary rounded-lg cursor-pointer"
                >
                  Entrar
                </button>
                <p className="flex justify-center w-full text-white text-[12px]">
                  Esqueceu a senha?
                  <a className="flex ml-2 text-blue-400 underline" href="">
                    clique aqui
                  </a>
                </p>
              </div>
