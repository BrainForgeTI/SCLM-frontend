        ...
        <PageLayout>
            <div className="flex flex-col gap-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 justify-center gap-6">
                    <PlanComponent nomePlan="Plano Explorador" description="Experimente o Atenium Gratuitamente e Descubra o Poder da IA na Educação!" estadoPlan={true} preco={"0"} keyPlan="price_1SMTZICgvpJPF4Xlfo6ViXGR"></PlanComponent>
