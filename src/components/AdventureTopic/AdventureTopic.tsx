  ...
  return (
    <div className={`w-full flex items-start gap-5 text-base-content ${props.setTopic ? 'flex-col' : ''} md:flex-row`}>
      <div className="flex gap-2 items-center">
        ...
        }} className={`${props.editMode ? 'hidden' : 'block'} w-[35px] h-[35px] lg:w-[27px] lg:h-[27px] shrink-0 rounded-[3px] cursor-pointer ${props.topic.completed ? 'bg-primary border border-neutral/22' : 'bg-secondary border border-neutral/22'}`}></button>
      </div>
